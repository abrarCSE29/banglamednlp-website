      ...
      <div className="w-full max-w-lg z-10">
        <div className="bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-slate-200 overflow-hidden">
          <div className="bg-slate-900 p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <h1 className="text-3xl font-bold tracking-tight text-white uppercase group font-poppins">
              Medical <span className="text-indigo-400">Triage</span>
            </h1>
          ...
          <div className="p-8 md:p-12 space-y-8">
            <form onSubmit={handleLogin} className="space-y-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  required
                  className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:border-indigo-500 focus:bg-white focus:ring-4 focus:ring-indigo-50 outline-none transition-all font-medium text-slate-900 placeholder:text-slate-300"
                  placeholder="name@institution.com"
                />
              </div>

              <div className="space-y-2">
                <label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest ml-1" htmlFor="password">Security Key</label>
                <input
                  id="password"
                  type="password"
                  value={password}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-5 bg-indigo-600 hover:bg-indigo-700 disabled:bg-slate-100 disabled:text-slate-400 text-white font-bold rounded-2xl transition-all shadow-xl shadow-indigo-100 active:scale-95 flex items-center justify-center gap-3 uppercase tracking-widest text-xs mt-4"
              >
            ...
            <div className="pt-8 border-t border-slate-100 text-center">
              ...
              <p className="text-[9px] text-slate-400 mt-2 leading-relaxed">
                By signing in, you agree to our Protocol Guidelines. <br />
                System version v2.4.0-ENT
              </p>
            </div>
          </div>
        </div>
